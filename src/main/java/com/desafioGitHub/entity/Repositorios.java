...
@JsonPropertyOrder({ "id", "node_id", "name", "full_name", "private", "owner", "html_url", "description", "fork", "url",
		...
		"open_issues_count", "license", "forks", "open_issues", "watchers", "default_branch" })
public class Repositorios {
	...
	public Repositorios(Integer id, String nodeId, String name, String fullName, Boolean _private, 
			...
			String svnUrl, Object homepage, Integer size, Integer stargazersCount, Integer watchersCount,
			...
			Integer openIssuesCount, Object license, Integer forks, Integer openIssues, Integer watchers,
	...
	public String toString() {
		return "ReposResponseGitHub [id=" + id + ", nodeId=" + nodeId + ", name=" + name + ", fullName=" + fullName
				...
				+ ", issueCommentUrl=" + issueCommentUrl + ", contentsUrl=" + contentsUrl + ", compareUrl=" + compareUrl
				+ ", mergesUrl=" + mergesUrl + ", archiveUrl=" + archiveUrl + ", downloadsUrl=" + downloadsUrl
				+ ", issuesUrl=" + issuesUrl + ", pullsUrl=" + pullsUrl + ", milestonesUrl=" + milestonesUrl
				+ ", notificationsUrl=" + notificationsUrl + ", labelsUrl=" + labelsUrl + ", releasesUrl=" + releasesUrl
				+ ", deploymentsUrl=" + deploymentsUrl + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt
				+ ", pushedAt=" + pushedAt + ", gitUrl=" + gitUrl + ", sshUrl=" + sshUrl + ", cloneUrl=" + cloneUrl
				+ ", svnUrl=" + svnUrl + ", homepage=" + homepage + ", size=" + size + ", stargazersCount="
				+ stargazersCount + ", watchersCount=" + watchersCount + ", language=" + language + ", hasIssues="
				+ hasIssues + ", hasProjects=" + hasProjects + ", hasDownloads=" + hasDownloads + ", hasWiki=" + hasWiki
				+ ", hasPages=" + hasPages + ", forksCount=" + forksCount + ", mirrorUrl=" + mirrorUrl + ", archived="
				+ archived + ", disabled=" + disabled + ", openIssuesCount=" + openIssuesCount + ", license=" + license
